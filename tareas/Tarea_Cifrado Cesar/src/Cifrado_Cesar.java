...
public class Cifrado_Cesar extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Cifrado_Cesar
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cifrado_Cesar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cifrado_Cesar().setVisible(true);
            }
        });
    }
